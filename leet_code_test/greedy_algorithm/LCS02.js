...
var halfQuestions = function (questions) {
  ...
  const kindArr = Object.values(map).sort((a, b) => b - a)
  let index = 0
  while (tempCount > 0) {
    const item = kindArr[index]
    if (tempCount !== 0) {
      tempCount -= item
      kindCount += 1
    }
...
// const questions = [1, 5, 1, 3, 4, 5, 2, 5, 3, 3, 8, 6]
// const questions = [2, 1, 6, 2]
const questions = [13, 8, 3, 7, 5, 6, 11, 12, 3, 6, 6, 11]
